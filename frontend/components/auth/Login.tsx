    ...
    >
      <Card className="bg-gray-900/80 border-gray-700/50 backdrop-blur-sm shadow-2xl">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-3xl font-bold text-white text-balance">Welcome Back</CardTitle>
          <CardDescription className="text-gray-400">Sign in to your RenoWise account</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="grid grid-cols-2 gap-3">
            <motion.div whileTap={{ scale: 0.98 }} transition={{ duration: 0.1 }}>
              <Button
                variant="outline"
                className="w-full bg-gray-800/50 border-gray-600/50 text-gray-300 hover:bg-gray-700/50 hover:text-white transition-all duration-200"
              >
